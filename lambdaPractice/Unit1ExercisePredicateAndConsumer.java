...
// Usage of Consumer interface and accpet Method
public class Unit1ExercisePredicateAndConsumer {
    public static void main(String[] args) {
        ...
        System.out.println("---------------------------");
        printSome(people,(p)->p.getFirstName().startsWith("R"),p-> System.out.println(p));
    ...
    public static void printSome(List<Person> people, Predicate<Person> condition, Consumer<Person> consumer) {
        for(Person p:people) {
            if(condition.test(p)) {
                consumer.accept(p);
            }
